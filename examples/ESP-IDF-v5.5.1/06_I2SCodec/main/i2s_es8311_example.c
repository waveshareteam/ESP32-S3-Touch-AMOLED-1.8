...
static i2c_master_bus_handle_t es_i2c_bus = NULL;
...
static esp_err_t es8311_codec_init(void)
{
    ...
    const i2c_master_bus_config_t es_i2c_cfg = {
    ...
    ESP_RETURN_ON_ERROR(i2c_new_master_bus(&es_i2c_cfg, &es_i2c_bus), TAG, "install i2c master bus failed");

    /* Initialize es8311 codec */
    es8311_handle_t es_handle = es8311_create(es_i2c_bus, ES8311_ADDRRES_0);
