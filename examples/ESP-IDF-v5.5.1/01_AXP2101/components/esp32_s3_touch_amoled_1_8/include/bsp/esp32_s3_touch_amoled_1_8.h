...
/**************************************************************************************************
 * ESP32-S3-Touch-AMOLED-1.8 pinout
 **************************************************************************************************/
...
#define BSP_LCD_TE            (GPIO_NUM_13)
#define BSP_LCD_TOUCH_RST     (GPIO_NUM_NC)
#define BSP_LCD_TOUCH_INT     (GPIO_NUM_21)

/* TCAL9534 I/O expander pins */
#define BSP_IO_EXPANDER_I2C_ADDR       (0x20)
#define BSP_IO_EXPANDER_LCD_RST        (0)
#define BSP_IO_EXPANDER_DSI_PWR_EN     (1)
#define BSP_IO_EXPANDER_TOUCH_RST      (2)
#define BSP_IO_EXPANDER_SD_CS          (7)
...
/**
 * @brief Mount SD card to virtual file system at /sdcard
 *
 * @return
 *      - ESP_OK on success
 *      - ESP_ERR_INVALID_STATE if already mounted by another caller
 *      - ESP_FAIL if card or filesystem can not be mounted
 *      - other error codes
 */
