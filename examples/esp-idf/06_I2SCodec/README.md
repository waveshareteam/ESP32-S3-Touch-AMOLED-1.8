...
* A development board with any supported Espressif SOC chip (see `Supported Targets` table above)
    * This port uses the ESP32-S3-Touch-AMOLED-1.8 audio pins directly and logs the detected board variant at startup.
...
* The legacy BSP option is ignored in this port because the example needs direct access to the I2S TX/RX handles.
